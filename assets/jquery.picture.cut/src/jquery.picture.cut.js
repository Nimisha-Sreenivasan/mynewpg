...
$(function() {
    ...
    PcLoading = {
        show: function(c, a) {
            var b = $("<div id='dialog-UiConfirm' class='uk-modal-dialog' ></div>");
                ...
                var TuyoshiCrop = function(element, response) {
                    ...
                    var JpaneDialogCallBack = function() {
                        ...
                        $("#JtuyoshiCrop #button_crop_original").bind("click", function() {
                            Retorno_Requisicao(element, response, 1); finalise_upload();
                        });
                ...
                var Setando_AjaxUpload = function(element) {
                    ...
                    element.uploadAjax({
                        ...
                        onComplete: function(response) {
                            ...
                            PcLoading.hide(); localStorage.setItem("image_name",response.currentFileName);
                            if (response.status) {
