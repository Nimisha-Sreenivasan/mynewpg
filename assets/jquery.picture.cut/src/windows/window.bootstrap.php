...
<div class="uk-form-row">
    <div class="uk-grid">            
        ...
        <div class="uk-width-medium-1-1 col-xs-12 col-md-8">		
		<div class="btn-group">
                    <select id="SelectOrientacao" title="Choose the Orientation of the cutout area"  class="form-control">    	    </select>
            <select id="SelectProporcao" title="Choose the Aspect Ratio of selection"  class="form-control">    	    </select>
			<button id="button_crop_recortar" class="uk-button uk-button-default">Crop</button>
			<button id="button_crop_original" class="uk-button uk-button-primary">Finish</button>
		</div>
   </div>
    </div>
</div>
<!--<div class="row">
  ...
  <div class="col-xs-2">
   ...
   <div class="uk-width-medium-1-1 col-xs-12 col-md-8">		
		<div class="btn-group">
			<button id="button_crop_recortar" class="btn btn-default">Cropccc</button>
