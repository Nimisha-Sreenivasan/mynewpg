                        ...
                        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                            ...
                            <div class="uk-dropdown uk-dropdown-small">
                                <ul class="uk-nav js-uk-prevent">
                                    ...
                                    <li><a href="<?php echo base_url()."PGownerLogin/logout"; ?>">Logout</a></li>
                                </ul>
                            </div>
                        </li>
            ...
            <ul>
                ...
                <li id="addguest" title="My Guest">
                    <a href="#">
					 ...
					 <ul>
                        <li><a href="<?php echo base_url()."pg_admin/MyGuest/addGuest" ?>">Add Guest</a></li>
                        <li><a href="<?php echo base_url()."pg_admin/GuestUploads/viewuploads" ?>">Guest Uploads</a></li>
                    </ul>
                </li>
                ...
                <li id="pgemployee" title="PG Employee">
                 ...
                 <li id="assetmanagement" title="Asset Management">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">&#xE84F;</i></span>
                        <span class="menu_title">Asset Management</span>
                    </a>
                </li>
                
                <li id="buyandsale" title="Buy and Sale">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">card_giftcard</i></span>
                        <span class="menu_title">Buy and Sale</span>
                    </a>
                </li>
				 <li title="Notification">
                    ...
                    <ul>
                        <li><a href="#">Group Notification</a>
                         <ul>
                        <li><a href="#">Guest</a></li>
                        <li><a href="#">Parents or Guardians</a></li>
                       
                        </ul></li>
                        <li><a href="#">Individual Notification</a></li>
                        <li><a href="#">Remainder List</a></li>
                        </ul>
                
                </li>
				
				  <li id="Reports" title="Reports">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">&#xE2C7;</i></span>
